        ...
        <div class="container">
            ...
            <div class="news__grid">
                <a href="http://b51168.jhtest.ru/news/?ELEMENT_ID=7" class="news__item">
                    <div class="news__img">
                        <img src="/upload/iblock/9e2/ehg0hdfh0cdol8izkoory08cm9y5035g.jpg"
                             alt=""/>
                    </div>
                    <div class="news__content">
                        <h3 class="news__title">
                            День открытых дверей для 120 подшефных кадет Ассоциации в Высшем военно-морском инженерном
                            училище
                        </h3>
                ...
                <a href="http://b51168.jhtest.ru/news/?ELEMENT_ID=11" class="news__item">
                    <div class="news__img">
                        <img src="/upload/iblock/c07/2m9oos25sregw8jnrw16k5c19426gdf5.jpg"
                             alt=""/>
                    </div>
                    <div class="news__content">
                        <h3 class="news__title">
        ...
        <div class="container">
            ...
            <div class="sliderinit2 slider--blue virtual__slider">
                <a href="/vuz-list/?ELEMENT_ID=21" class="news__item">
                    ...
                    <div class="news__content">
                        <h3 class="news__title">
                            Военно-морской институт – морской корпус Петра Пеликого ВУНЦ ВМФ «Военно-морская академия»
                        </h3>
                ...
                <a href="/vuz-list/?ELEMENT_ID=19" class="news__item">
                    ...
                    <div class="news__content">
                        ...
                        <div class="news__city">Калининград</div>
                    </div>
                </a>
